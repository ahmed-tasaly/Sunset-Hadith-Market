...
object APIYoutubeKey {
    ...
    private const val myEncodedApiKey = API_KEY_PART_1 + API_KEY_PART_2 + API_KEY_PART_3 + API_KEY_PART_4

    private val decodedApiKey = Base64.decode(myEncodedApiKey, Base64.DEFAULT)
