...
class NightHadithsData {
    ...
    private val hadithsList = mutableListOf(
        ...
        "عَنْ حُذَيْفَةَ بْنِ الْيَمَانِ رضي الله عنه قَالَ :\n" +
                ...
                "\n" +
                "رواه البخاري",
        "عَنْ الْبَرَاءِ بْنِ عَازِبٍ قَالَ : قَالَ النَّبِيُّ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ :\n" +
                "\n" +
        ...
        "عَنْ أَبِي هُرَيْرَةَ رضي الله عنه قَالَ : قَالَ النَّبِيُّ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ :\n" +
                "\n" +
                ...
                "\n" +
                "رواه البخاري",
        "عَنْ عَلِيِّ بْنِ أَبِي طَالِبٍ رضي الله عنه أَنَّ فَاطِمَةَ رضي الله عنها أَتَتْ النَّبِيَّ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ تَسْأَلُهُ خَادِمًا ، فَقَالَ :\n" +
                "\n" +
        ...
        "عَنْ أَنَسٍ رضي الله عنه أَنَّ رَسُولَ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ كَانَ إِذَا أَوَى إِلَى فِرَاشِهِ قَالَ :\n" +
                "\n" +
                "( الْحَمْدُ لِلَّهِ الَّذِي أَطْعَمَنَا وَسَقَانَا وَكَفَانَا وَآوَانَا فَكَمْ مِمَّنْ لَا كَافِيَ لَهُ وَلَا مُؤْوِيَ )\n" +
                "\n" +
                "رواه مسلم",
        "عَنْ عَبْدِ اللَّهِ بْنِ عُمَرَ أَنَّهُ أَمَرَ رَجُلًا إِذَا أَخَذَ مَضْجَعَهُ قَالَ :\n" +
                "\n" +
        ...
        "عن سهيل قال : كَانَ أَبُو صَالِحٍ يَأْمُرُنَا - إِذَا أَرَادَ أَحَدُنَا أَنْ يَنَامَ - أَنْ يَضْطَجِعَ عَلَى شِقِّهِ الْأَيْمَنِ ثُمَّ يَقُولُ :\n" +
                "\n" +
        ...
        "عَنْ عَلِيٍّ رضي الله عنه عَنْ رَسُولِ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ أَنَّهُ كَانَ يَقُولُ عِنْدَ مَضْجَعِهِ :\n" +
                "\n" +
                ...
                "\n" +
                "رواه أبو داود",
        "عَنْ أَبِي الْأَزْهَرِ الْأَنْمَارِيِّ أَنَّ رَسُولَ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ كَانَ إِذَا أَخَذَ مَضْجَعَهُ مِنْ اللَّيْلِ قَالَ : ( بِسْمِ اللَّهِ وَضَعْتُ جَنْبِي ، اللَّهُمَّ اغْفِرْ لِي ذَنْبِي ، وَأَخْسِئْ شَيْطَانِي ، وَفُكَّ رِهَانِي ، وَاجْعَلْنِي فِي النَّدِيِّ الْأَعْلَى ) رواه أبو داود"
    )

    fun getNewNightHadith(context: Context): String {
