...
import com.moataz.afternoonhadeeth.ui.images.viewmodel.ImagesAqsaaViewModel
import com.moataz.afternoonhadeeth.utils.status.Resource
import com.moataz.afternoonhadeeth.utils.status.Status

class ImagesAqsaFragment : Fragment() {
    private var adapter =
        ImagesOtherAdapter()
    private var viewModel = ImagesAqsaaViewModel()
    ...
    private fun initializeViewModel() {
        viewModel = ViewModelProvider(this).get(ImagesAqsaaViewModel::class.java)
    }
}