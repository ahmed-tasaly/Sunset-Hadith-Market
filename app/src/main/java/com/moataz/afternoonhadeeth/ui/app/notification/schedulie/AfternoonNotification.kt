...
import com.moataz.afternoonhadeeth.data.source.HadithsData
...
class AfternoonNotification : BroadcastReceiver() {
    ...
    private val CHANNEL_ID = "HADITH_KANZHASANAT_CHANNEL_ID"
    private var NOTIFICATION_TITLE = "كنز الحسنات"
    private var NOTIFICATION_MESSAGE = HadithsData().firstHadith()
    ...
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        val channel = NotificationChannel(
            CHANNEL_ID,
            "Channel_HADITH_KANZHASANAT_CHANNEL_ID",
    ...
    fun setupAfternoonNotification(context: Context) {
        ...
        if (cal.timeInMillis > System.currentTimeMillis()) {
            val notificationIntent = Intent(context, AfternoonNotification::class.java)
